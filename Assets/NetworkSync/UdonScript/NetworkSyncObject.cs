                ...
                switch(subcmd)
                {
                    ...
                    case "pong":
                        if(EventObject != null)
                        {
                            argSrcPlayer = srcPlayer;
                            argCmd = null;
                            var args = new object[2]{arg, (int)((Time.unscaledTimeAsDouble - ((double)arg)) * 1000.0 + 0.5)};
                            argArg = args;
                            argReturnValue = null;
                        ...
                        {
                            NetworkSync_OnPongReceived(srcPlayer, (double)arg, (int)((Time.unscaledTimeAsDouble - ((double)arg)) * 1000.0 + 0.5));
                        }
